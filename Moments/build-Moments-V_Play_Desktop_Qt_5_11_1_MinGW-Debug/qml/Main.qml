          ...
          AppMap {
                   ...
                   Rectangle {
                           ...
                           IconButton {
                               ...
                               onClicked: {
                                   var csvString= "Species,"+"St. Lat,"+"St. Long,"+"End Lat,"+"End Long,"+"Action Given,"+"Action Recv"

                                   for(var i = 0; i < mapModel.count; i++){
                                       csvString += "\n"+mapModel.get(i).s+","+mapModel.get(i).lat+","+mapModel.get(i).longi+","+mapModel.get(i).eLat+","
                                               +mapModel.get(i).eLong+mapModel.get(i).giv+","+mapModel.get(i).recv
                                   }
                                   //myFile.source = "test1.csv"
